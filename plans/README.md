...
| --- | --- | --- | --- | --- |
| 001 | Investigate (and fix if confirmed) Radix overlay open/close keyframe restart | HIGH | TODO | [001-radix-overlay-transitions.md](001-radix-overlay-transitions.md) |
| 002 | Expand prefers-reduced-motion coverage beyond 4 classes | HIGH | TODO | [002-reduced-motion-coverage.md](002-reduced-motion-coverage.md) |
| 003 | Gate hover-triggered transforms behind `(hover: hover) and (pointer: fine)` | HIGH | TODO | [003-hover-touch-gate.md](003-hover-touch-gate.md) |
| 004 | Move sidebar collapse off width/margin thrash onto `--ease-in-out-apple` | HIGH | TODO | [004-sidebar-collapse-transform.md](004-sidebar-collapse-transform.md) |
| 005 | Add press feedback to primary sidebar navigation controls | HIGH | TODO | [005-sidebar-press-feedback.md](005-sidebar-press-feedback.md) |
...
| 008 | Progress bars: animate `transform` not `width` (mirror `ui/progress.tsx`) | MEDIUM | TODO | [008-progress-bars-transform.md](008-progress-bars-transform.md) |
...
| 011 | Sync sale-toast progress bar to Sonner's real timer, add celebratory entrance | MEDIUM-HIGH | TODO | [011-sale-toast-timer-sync.md](011-sale-toast-timer-sync.md) |
...
| 013 | Give task-completion checkbox and title a small motion budget | LOW-MEDIUM | TODO | [013-task-complete-animation.md](013-task-complete-animation.md) |
