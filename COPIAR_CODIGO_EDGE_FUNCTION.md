# Código para Colar no Editor do Supabase
...
1. Verifique se a função aparece na lista de Edge Functions
2. Execute a migration SQL (ver `CHECKLIST_PUSH_NOTIFICATIONS.md`)
3. Teste ativando as notificações push no app!
