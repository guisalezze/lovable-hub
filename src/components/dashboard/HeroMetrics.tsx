  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 stagger-in">
      {cards.map((card) => (
        <div
          key={card.label}
          className={`rounded-xl border border-border/60 border-l-4 ${card.border} bg-gradient-to-br ${card.bg} backdrop-blur-xl p-6 shadow-sm hover:shadow-md hero-metric-hover transition-[box-shadow,transform] duration-200 ease-[var(--ease-out-apple)]`}
        >
