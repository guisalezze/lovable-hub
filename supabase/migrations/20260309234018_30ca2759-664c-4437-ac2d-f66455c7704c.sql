...
-- 1. Add client_email to charges
ALTER TABLE public.charges ADD COLUMN IF NOT EXISTS client_email text;

-- 2. Create client_ltv view
...
-- 3. Create search_clients function
